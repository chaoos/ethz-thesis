...
The contents of \cref{part:gpu} are partly relying on ref.~\citeOwn{pasc24} which is currently unpublished, but journal publication is in preparation.
Preliminary results were published in the conference proceeding ref.~\citeOwn{lattice24:roman}.

The contents of \cref{part:variance} are based on a conference proceeding ref.~\citeOwn{lattice23:lma}, whereas most of the results rely on ref.~\citeOwn{mglma}.
