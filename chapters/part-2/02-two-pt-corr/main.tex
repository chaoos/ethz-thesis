...
A discussion of common evaluation strategies will follow, culminating in an analysis of low-mode averaging, its problems in terms of its unfortunate quadratic volume scaling and challenges that emerge when evaluating the remaining pieces not attributed to the low modes.
