...
Even regarding observable evaluation, further functionality such as the \ggrp{U}{1} clover field generation or access to \qudas contraction routines could be considered for further offloading.
