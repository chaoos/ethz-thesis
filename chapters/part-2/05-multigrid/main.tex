...
\tldr{mg intro}
In this chapter we will discuss multigrid as a concept and its prominent role as a solver preconditioner.
After that, we will construct a decomposed propagator in terms of contributions from multigrid levels.
...
This defines a new class of variance reduction methods which we call \emph{multigrid low-mode averaging}.
