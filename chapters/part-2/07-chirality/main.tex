...
The main equation we want to establish in this chapter is
\begin{equation}
...
\begin{equation}
\coarse{K} = \coarse{\Gamma^{5}} \coarse{\Gamma^{5}} \coarse{K} = \sum_{i} \coarse{\lambda}_i \coarse{\Gamma^{5}} \psi_i \psi_i^{\dagger} \;,
\end{equation}
...
Comparing the areas of the numerical range and the spectral hull can be measure for non-normality.
