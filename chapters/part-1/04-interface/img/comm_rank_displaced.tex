...
\begin{tikzcd}
  ...
  \arrow["argument"', dashed, from=11-5, to=10-4]
  \arrow["argument"', dashed, from=11-5, to=11-3]
  \arrow["member", dashed, from=11-5, to=11-6]
  \arrow["argument"', dashed, tail reversed, no head, from=12-4, to=11-5]
\end{tikzcd}
\end{document}
