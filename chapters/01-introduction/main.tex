...
For typical lattice QCD simulations with dynamical fermions, the computational simulation cost in the lattice spacing $a$ and the lattice volume $V$ can be modelled as~\cite{Luscher:1998pe}
\begin{equation}
