...
First, a direct evaluation using point sources that goes along the choice of a set of sources points (called $\Omega$ in the text, a subset of all lattice points).
