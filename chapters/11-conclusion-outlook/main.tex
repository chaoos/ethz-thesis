...
With access to a powerful multigrid solver on the GPU, all ingredients are there to substantially improve our modest implementation of multigrid low-mode averaging.
...
This might be an interesting application to continue.
