...
\node (R4) [rank] [fit={(C40) (C51)}] {}; \node (LR4) [fill=white, text=black] at (R4.south) {\hit{rank 4}};
\node (R5) [rank] [fit={(C60) (C71)}] {}; \node (LR5) [fill=white, text=black] at (R5.south) {rank 5};
\node (R2) [rank] [fit={(C02) (C13)}] {}; \node (LR2) [fill=white, text=black] at (R2.south) {rank 2};
\node (R3) [rank] [fit={(C22) (C33)}] {}; \node (LR3) [fill=white, text=black] at (R3.south) {rank 3};
...
\node (B0) [block] [fit={(R0) (R1) (R2) (R3) (LR0) (LR1) (LR2) (LR3)}]         {}; \node[fill=white, text=black] at (B0.north) {block 0};
\node (B1) [block] [fit={(R4) (R5) (R6) (R7) (LR4) (LR5) (LR6) (LR7)}]         {}; \node[fill=white, text=black] at (B1.north) {block 1};
\node (B2) [block] [fit={(R8) (R9) (R10) (R11) (LR8) (LR9) (LR10) (LR11)}]     {}; \node[fill=white, text=black] at (B2.north) {block 2};
\node (B3) [block] [fit={(R12) (R13) (R14) (R15) (LR12) (LR13) (LR14) (LR15)}] {}; \node[fill=white, text=black] at (B3.north) {block 3};
