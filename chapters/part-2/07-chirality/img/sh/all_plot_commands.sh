...
${PYTHON} ${PPATH}/scripts/num_range.py -v -N 4 \
	...
	--names "LMA" 'MG $6^4$' 'MG $4^4$' "fine" --title 'Spectral hull: $i=4$, $N_s=2$, $N_c=20$.' \
...
${PYTHON} ${PPATH}/scripts/num_range.py -v -N 4 \
	...
	--names "LMA" 'MG $6^4$' 'MG $4^4$' "fine" --title 'Spectral hull: $i=1$, $N_s=1$, $N_c=20$.' \
	--conjugate no no no yes --ylim -4 2 --xlim -0.25 7.25 --points no yes \
	--only-visible no no no no --only-visible no no no yes \
	--inset 0.1 0.1 0.5 0.4 --xscale linear log --aspect equal 15 --ylim -0.05 0.05 --xlim 1e-3 0.1
...
${PYTHON} ${PPATH}/scripts/num_range.py -v -N 4 \
	...
	--names "LMA" 'MG $6^4$' 'MG $4^4$' "fine" --title 'Spectral hull: $i=2$, $N_s=2$, $N_c=20$.' \
	--conjugate no no no yes --ylim -4 2 --xlim -0.25 7.25 --points no yes \
	--only-visible no no no no --only-visible no no no yes \
	--inset 0.1 0.1 0.5 0.4 --xscale linear log --aspect equal 15 --ylim -0.05 0.05 --xlim 1e-3 0.1
...
${PYTHON} ${PPATH}/scripts/num_range.py -v -N 4 \
	...
	--names "LMA" 'MG $6^4$' 'MG $4^4$' "fine" --title 'Spectral hull: $i=6$, $N_s=4$, $N_c=20$.' \
	--conjugate no no no yes --ylim -4 2 --xlim -0.25 7.25 --points no yes \
	--only-visible no no no no --only-visible no no no yes \
	--inset 0.1 0.1 0.5 0.4 --xscale linear log --aspect equal 15 --ylim -0.05 0.05 --xlim 1e-3 0.1
