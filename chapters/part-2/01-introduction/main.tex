...
Powerful variance reduction methods are needed to tackle the light-quark connected part in particular, which suffers from poor signal-to-noise ratios at large distances.
...
According to the last paragraphs, variance reduction should systematically target the large distance part of the connected LO-HVP.
