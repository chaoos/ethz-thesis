...
${PYTHON} ${PPATH}/scripts/num_range.py -v -N 4 \
	...
	--names "LMA" 'MG $6^4$' 'MG $4^4$' "fine" --title 'Numerical range: $N_s=1$, $N_c=20$.' \
...
${PYTHON} ${PPATH}/scripts/num_range.py -v -N 4 \
	...
	--names "LMA" 'MG $6^4$' 'MG $4^4$' "fine" --title 'Numerical range: $N_s=2$, $N_c=20$.' \
...
${PYTHON} ${PPATH}/scripts/num_range.py -v -N 4 \
	...
	--names "LMA" 'MG $6^4$' 'MG $4^4$' "fine" --title 'Numerical range: $N_s=4$, $N_c=20$.' \
	--conjugate yes yes yes yes --inset 0.65 0.05 0.4 0.4 --xlim -0.5 7.8 --xlim -0.2 0 --ylim -2.5 2.5 --ylim -0.1 0.1
...
${PYTHON} ${PPATH}/scripts/num_range.py -v -N 4 \
	...
	--names "LMA" 'MG $6^4$' 'MG $4^4$' "fine" --title 'Numerical range: $i=4$, $N_s=2$, $N_c=20$.' \
	--inset 0.65 0.05 0.4 0.4 --xlim -0.5 7.8 --xlim -0.02 0.02 --ylim -2.5 2.5 --ylim -0.02 0.02
