...
\node[solve] (solve2) at (solve1.east) {solve \#2};
\node[contr] (contr2) at ([yshift=-20pt] solve2.east) {contract \#2};

\node[solve] (solve3) at (solve2.east) {solve \#3};
...
\draw [
    ...
    decorate
] (cpu.east) -- (contr1.west) 
node [pos=0.5,anchor=north,yshift=-15pt] {warm-up phase}; 
...
\draw [
    ...
    decorate
] (contr3.west) -- (contr3.east) 
node [pos=0.5,anchor=north,yshift=-15pt] {wind-down phase}; 
