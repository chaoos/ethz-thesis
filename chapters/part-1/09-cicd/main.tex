...
This chapter details our strategy for continuous integration in \cref{sec:cicd:integration}, continuous testing directly on target hardware at CSCS in \cref{sec:cicd:testing} and software deployment to CSCS infrastructure in \cref{sec:cicd:deployment}.
